...
import com.tech.engg5.csv.batch.processor.exception.S3MultiPartUploadException;
...
public class S3MultiPartUpload {
  ...
  public final AtomicInteger uploadPartNumber = new AtomicInteger(0);
  ...
  private void submitUploadPart(
      ByteArrayInputStream inputStream, int partNumber, boolean finalPart) {
    submitTask(() -> {
  ...
  public void uploadStream(InputStream inputStream, int bufferSize) throws IOException {
