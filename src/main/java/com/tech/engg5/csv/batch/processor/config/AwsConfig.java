...
import com.tech.engg5.csv.batch.processor.model.properties.S3;
...
public class AwsConfig {
  ...
  public AmazonS3 s3Client() throws Exception {
    LOG.info("Initializing S3 Client at runtime.");
    ...
    AWSCredentialsProvider credentialsProvider =
      new AWSStaticCredentialsProvider(new BasicAWSCredentials(s3props.getAccessKey(), s3props.getSecretKey()));
    AwsClientBuilder.EndpointConfiguration endpointConfiguration =
      new AwsClientBuilder.EndpointConfiguration(s3props.getEndpoint(), s3props.getRegion());
